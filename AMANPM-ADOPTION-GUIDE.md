...
| Invariant | Meaning |
|-----------|---------|
| **Single SSOT** | `index.yaml` is the only source of truth for state |
| **AI Never Edits Strategy** | Epics, CLAUDE.md, validation/ are human-owned |
| **Humans Never Edit Auto-Generated** | `index.yaml` is regenerated by `/aman sync` only |
...
*Version 2.1.0 | Feedback integration: self-healing & resilience | 2026-02-01*
